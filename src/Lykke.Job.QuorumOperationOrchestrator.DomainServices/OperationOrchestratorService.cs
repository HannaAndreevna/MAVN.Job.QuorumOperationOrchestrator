...
using Lykke.Job.QuorumOperationOrchestrator.Domain;
using Lykke.Job.QuorumOperationOrchestrator.Domain.Models;
...
namespace Lykke.Job.QuorumOperationOrchestrator.DomainServices
{

...
using Lykke.Job.QuorumOperationOrchestrator.DomainServices;
using Lykke.Job.QuorumOperationOrchestrator.PeriodicalHandlers;
using Lykke.Job.QuorumOperationOrchestrator.Services;
...
namespace Lykke.Job.QuorumOperationOrchestrator.Modules
{
    [UsedImplicitly]

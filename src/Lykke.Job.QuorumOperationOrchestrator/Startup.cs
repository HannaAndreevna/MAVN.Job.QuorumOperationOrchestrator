...
using Lykke.Job.QuorumOperationOrchestrator.Settings;
using Microsoft.AspNetCore.Builder;
using Microsoft.Extensions.DependencyInjection;
using System;
using Lykke.Sdk;

namespace Lykke.Job.QuorumOperationOrchestrator
{
    [UsedImplicitly]
    public class Startup
    {
        ...
        {
            ApiTitle = "QuorumOperationOrchestratorJob API",
            ApiVersion = "v1"
        };
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            return services.BuildServiceProvider<AppSettings>(options =>
            {
                ...
                options.Logs = logs =>
                {
                    logs.AzureTableName = "QuorumOperationOrchestratorJobLog";
                    logs.AzureTableConnectionStringResolver = settings => settings.QuorumOperationOrchestratorJob.Db.LogsConnString;
                    ...
                    logs.Extended = extendedLogs =>
                    {
                        ...
                        extendedLogs.AddAdditionalSlackChannel("QuorumOperationOrchestrator", channelOptions =>
                        {
